...
# --- Main Run ---
def run_fedchar(train_datasets, test_datasets, num_clients, num_rounds=40, 
                initial_rounds=10, alpha=0.1, clients_per_round=10, 
                epochs_per_round=5, seed=42, fine_tune_epochs=3):
