...
# --- Main Run ---
def run_fedsnip(train_datasets, test_datasets, num_clients, num_rounds=50, 
                clients_per_round=10, alpha=0.1, target_sparsity=0.7, seed=42,
                fine_tune_epochs=3):
    ...
    for cid, client in clients.items():
        client.fine_tune(final_w, global_masks, epochs=fine_tune_epochs)
        res = client.evaluate()
        results[cid] = res
